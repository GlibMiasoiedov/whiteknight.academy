...
import { 
  ...
  Video, MessageSquare, Mail, Play, Star, ChevronRight, Menu, Instagram, Facebook, Twitter, Youtube,
  HelpCircle, ChevronUp, Briefcase, MousePointer2, UserMinus, UserPlus, TrendingDown,
  BarChart3, LineChart, FileSearch, ArrowRight, ShieldCheck, UserCheck, Crosshair, Bot, Info,
  MapPin, Globe, Loader2, ArrowLeft, AlertCircle
} from 'lucide-react';
...
// --- STYLES & FONTS ---
const FONTS = {
  h1: 'font-display text-4xl md:text-5xl lg:text-7xl font-bold tracking-tight', 
  h2: 'font-display text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight',
  label: 'font-body text-sm font-bold uppercase tracking-wider',
  body: 'font-body text-lg md:text-xl font-medium leading-relaxed',
  kpi: 'font-display text-4xl md:text-6xl font-extrabold tracking-tight',
  logo: 'font-display text-2xl md:text-3xl font-bold tracking-tight',
};
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="flex flex-col gap-4 mb-8">
           <div className="flex flex-col sm:flex-row gap-6">
              <button onClick={onRegister} className={`px-10 py-5 rounded-full bg-white text-slate-900 font-bold text-xl shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:bg-slate-100 transition-all hover:-translate-y-1 flex items-center justify-center gap-3 group ${FONTS.body}`}>
                Get Your Free Starter Report
...
// --- STAT ROSE CHART ---
const StatRoseChart = ({ activeSlice, onHover, stats }) => {
  const size = 650;
  const center = size / 2;
      ...
      <div className="relative w-[750px] h-[750px] transition-transform duration-500 hover:scale-[1.02]">
        ...
        >
          ...
          {stats.map((stat, i) => {
            ...
            const p1 = getCoordinatesForAngle(startAngle, 0); 
...
const VisualizationSection = ({ onRegister }) => {
     ...
     <div className="w-full px-6 md:px-12 lg:px-24">
        <div className="flex flex-col lg:flex-row items-center gap-24">
           ...
           <div className="flex-1 w-full">
              ...
              <div className="mt-12">
                <button onClick={onRegister} className={`px-10 py-4 rounded-full bg-white text-slate-900 font-bold text-lg shadow-lg hover:bg-slate-100 transition-all hover:-translate-y-1 ${FONTS.body}`}>
                    Get Your Free Starter Report
                </button>
              </div>
           </div>
...
const OpponentAnalysisSection = ({ onRegister }) => {
...
const CoachingVsAutoSection = ({ onRegister }) => (
  <section id="coaching" className="py-40 relative z-10">
     <div className="w-full px-6 md:px-12 lg:px-24 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
           ...
           <GlassCard className="p-12 text-left ring-1 ring-violet-500/50 shadow-[0_0_80px_-20px_rgba(139,92,246,0.15)] bg-gradient-to-br from-violet-900/20 to-transparent">
...
const BeginnersSection = ({ onRegister }) => (
...
const RegistrationModal = ({ isOpen, onClose, onLoginSuccess, onSwitchToRegister, mode = 'register' }) => {
    ...
    const handleEmailSubmit = (e) => {
        ...
        setTimeout(() => {
            ...
            // In a real app, this would be an API call response
     ...
     <div className="w-full px-6 md:px-12 lg:px-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
           ...
           <GlassCard className="p-14 ring-1 ring-violet-500/50 shadow-[0_0_80px_-15px_rgba(139,92,246,0.3)] relative bg-gradient-to-b from-white/10 to-transparent">
              ...
              <button onClick={onRegister} className={`w-full py-5 rounded-3xl bg-white text-slate-900 font-bold hover:bg-slate-200 transition-all shadow-[0_0_30px_rgba(255,255,255,0.3)] text-lg ${FONTS.body}`}>Start 14-day Free Trial</button>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
            <div>
               ...
               <div className="mb-16">
                  ...
                  <div className="flex gap-6 relative w-fit">
                      {/* Removed "Mobile app coming soon" overlay as per previous request */}
                      <div className="flex items-center gap-4 bg-black text-white px-8 py-4 rounded-3xl border border-slate-800 opacity-40 grayscale">
                         <AppleIcon />
                  ...
                  <p className="text-slate-500 text-xs mt-3 opacity-60">(in development)</p>
               </div>
...
const LandingPage = ({ onRegister, onLogin }) => (
  <div className="min-h-screen font-sans text-white selection:bg-violet-500/30 overflow-hidden relative">
    <BackgroundMesh />
    <style>{`
    ...
    <WhySection />
    <VisualizationSection onRegister={onRegister} />
    <OpponentAnalysisSection onRegister={onRegister} />
    <CoachingVsAutoSection onRegister={onRegister} />
    <BeginnersSection onRegister={onRegister} />
    <ResultsSection />
...
const App = () => {
  ...
  if (isLoggedIn) {
    return (
        <div className="min-h-screen bg-[#080C14] text-white flex flex-col items-center justify-center font-sans">
            <h1 className="text-4xl font-bold mb-4 text-violet-500">White Knight Analytics Dashboard</h1>
            <p className="text-slate-400 mb-8">You have successfully logged in.</p>
            <button onClick={() => setIsLoggedIn(false)} className="px-6 py-2 rounded-full border border-slate-700 hover:bg-slate-800 transition-colors">
                Back to Landing
            </button>
        </div>
    );
  ...
  return (
    <div className="font-sans text-white">
      <style>{`
        ...
        body { font-family: 'Manrope', sans-serif; background-color: #080C14; }
        .font-display { font-family: 'Unbounded', sans-serif; }
        .font-body { font-family: 'Manrope', sans-serif; }
      `}</style>
      <LandingPage onRegister={openRegister} onLogin={openLogin} />
      <RegistrationModal 
