# Sync mu-plugins from WordPress server to local

. "$PSScriptRoot\..\.agent\config.ps1"

$localMuPluginsDir = "$PSScriptRoot\..\mu-plugins"
...
Write-Host "Syncing mu-plugins from server..." -ForegroundColor Cyan
Download-FtpDirectory -FtpPath "/wp-content/mu-plugins/" -LocalPath $localMuPluginsDir
