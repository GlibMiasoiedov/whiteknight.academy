...
const App = () => {
    ...
    return (
        <div className="min-h-screen bg-[#05060B] text-slate-200 font-sans selection:bg-purple-500/30">
            ...
            <main className="relative z-10 max-w-6xl mx-auto px-6 pb-24 pt-4">
                <div className="mb-12">
                    <button className="flex items-center gap-2 text-slate-500 hover:text-white transition-colors mb-8 group text-sm font-medium">
                        ...
                        <div className="relative bg-[#11131F] border border-white/[0.06] rounded-3xl p-8 overflow-hidden shadow-2xl">
                            ...
                            <div className="flex justify-between items-start mb-8">
                                <div>
                                    <h2 className="text-xl font-bold text-white tracking-tight flex items-center gap-2">
                                        Pro Plan
                                        <div className="px-2 py-0.5 bg-[#34D399]/10 rounded text-[#34D399] text-[10px] font-bold uppercase tracking-wider border border-[#34D399]/20">
                                            Coach-Ready
                                        </div>
                                    </h2>
                            ...
                            <div className="space-y-5 mb-8">
                                <div className="flex justify-between items-baseline group">
                                    ...
                                    <span className="text-white font-bold text-2xl tracking-tight">€0.00</span>
                                </div>
                            ...
                            <form onSubmit={handleSubmit} className="relative z-10 space-y-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <button type="button" className="group relative h-12 bg-[#1A1D2B] hover:bg-[#232738] text-white border border-white/5 rounded-xl font-bold flex items-center justify-center transition-all">
                                        ...
                                        <button type="button" className="group h-12 bg-[#1A1D2B] hover:bg-[#232738] text-white border border-white/5 rounded-xl font-bold flex items-center justify-center transition-all">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group rounded-xl bg-[#0B0E14] border border-white/10 focus-within:border-[#7C3AED]/50 shadow-inner transition-all">
                                            <div className="flex items-center border-b border-white/5">
                                                ...
                                                <input
                                                    type="text"
                                                    className="w-full bg-transparent border-none text-slate-200 text-sm px-3 py-3.5 focus:outline-none focus:ring-0 placeholder:text-slate-600"
                                                    placeholder="Card number"
                                                />
                                                <div className="mr-4 flex gap-1.5 opacity-40">
                                                    <div className="w-7 h-4 bg-slate-600 rounded-sm" />
                                                    <div className="w-7 h-4 bg-slate-600 rounded-sm" />
                                                </div>
                                            </div>
                                            <div className="flex divide-x divide-white/5">
                                                <input
                                                    type="text"
                                                    className="w-1/2 bg-transparent border-none text-slate-200 text-sm px-4 py-3.5 focus:outline-none focus:ring-0 placeholder:text-slate-600 text-center"
                                                    placeholder="MM / YY"
                                                />
                                                <input
                                                    type="text"
                                    ...
                                    >
                                        <div className="relative z-10 flex items-center justify-center gap-2.5">
                                            {isSubmitting ? (
                                                ...
                                                <>
                                                    <span className="text-[15px] tracking-wide">Start 14-day Free Trial</span>
