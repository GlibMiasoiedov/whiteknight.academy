...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, theme, userMenuOpen, setUserMenuOpen, onUpgradeClick, isDemoMode, isOpen, onClose }) => {
    const navItems = [
    ...
    return (
        <>
            ...
            <div className={`fixed top-0 left-0 h-screen w-[260px] border-r border-white/5 flex flex-col justify-between z-50 bg-[#080C14] transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'} 2xl:translate-x-0`}>
                <div>
