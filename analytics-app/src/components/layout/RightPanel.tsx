                        ...
                        <div className="p-4 xl:p-6 flex-1">
                            {reportContextTab === 'insights' && (() => {
                                ...
                                const WIDGET_HINTS: Record<string, { title: string; desc: string; action: string; trainingTitle: string; wTitle: string; wDesc: string; sTitle: string; sDesc: string; }> = {
                                    ...
                                    'biometrics-sleep': { title: 'About: Sleep vs Performance', desc: 'Correlates the duration of your sleep from the previous night with your daily average chess accuracy and blunder rate.', action: 'Aim for 7-8 hours of sleep for peak performance.', trainingTitle: 'Recovery & Performance', wTitle: 'Sleep Deprivation Impact', wDesc: 'Sub-6h sleep highly correlates with endgame blunders.', sTitle: 'Well-Rested Accuracy', sDesc: 'Peak performance maintained after 7+ hours.' },
                                    'biometrics-hrv': { title: 'About: HRV Status', desc: 'Uses Heart Rate Variability (HRV) as a proxy for central nervous system stress to suggest your readiness to play rated games.', action: 'Avoid rated games on low HRV days.', trainingTitle: 'Physiological Readiness', wTitle: 'High CNS Stress', wDesc: 'Your HRV indicates accumulated fatigue or stress.', sTitle: 'Prime Readiness', sDesc: 'Your nervous system is fully recovered.' },
                                    'biometrics-recovery': { title: 'About: Post-Loss Recovery', desc: 'Measures the time interval between a loss and the start of your next game, warning you of potential "tilt".', action: 'Wait 2 minutes after a tough loss.', trainingTitle: 'Tilt Management', wTitle: 'Rushing Games', wDesc: 'You start new games too quickly while heart rate is elevated.', sTitle: 'Good Discipline', sDesc: 'You wait until your HR normalizes.' },
                                    'biometrics-fatigue': { title: 'About: Session Fatigue Decay', desc: 'Tracks how your heart rate and accuracy change as a gaming session gets longer.', action: 'Take breaks every 4-5 games.', trainingTitle: 'Session Management', wTitle: 'Fatigue Drop', wDesc: 'Accuracy plummets while HR rises after 5 games.', sTitle: 'Early Focus', sDesc: 'First 3 games of a session show highest precision.' },
                                    'biometrics-adrenaline': { title: 'About: Micro-Stress Reactions', desc: 'Maps sudden heart rate spikes against sudden evaluation swings (like an opponent blundering).', action: 'Take a deep breath when you spot a winning tactic.', trainingTitle: 'Emotional Regulation', wTitle: 'Rushing on Advantage', wDesc: 'You tend to blunder back immediately after a HR spike.', sTitle: 'Calm Conversions', sDesc: 'You maintain a steady HR when securing wins.' },
                                    'biometrics-circadian': { title: 'About: Circadian Rhythm', desc: 'A biological performance window heatmap. Combines your win rate with stress levels to find your perfect time to play.', action: 'Play demanding matches during peak hours.', trainingTitle: 'Routine Optimization', wTitle: 'Late Night Tilt', wDesc: 'Terrible focus and high stress after midnight.', sTitle: 'Peak Hours', sDesc: 'Saturday mornings are your undisputed best time.' },
                                };
