            ...
            <div className="w-full px-6 md:px-12 lg:px-16 xl:px-24">
                <div className="flex flex-col md:flex-row items-center gap-8 lg:gap-12 xl:gap-16">
                    ...
                    <div className="flex-1 text-center md:text-left order-2 md:order-1">
                        ...
                        {/* MOBILE CHART (block md:hidden) */}
                        <div className="block md:hidden mb-8 w-full order-2">
                            ...
                            <div className="p-2 relative">
                                ...
                                {/* Chart Area */}
                                <div className="relative h-[250px] w-full flex items-end gap-1 px-2 ml-2">
                                    {/* Grid Lines & Labels */}
                                    ...
                                    {[
                                        ...
                                        <div key={index} className="flex-1 h-full flex flex-col justify-end chart-bar-group relative z-10">
                                            {/* Bar */}
                                            <div
                                                className="chart-bar w-full bg-gradient-to-t from-violet-700 to-violet-400 rounded-t-sm md:rounded-t-md shadow-[0_0_8px_rgba(139,92,246,0.2)]"
                                                style={{ height: `${height}%` }}
                                            ></div>

                                            {/* Tooltip on hover */}
                                            <div className="chart-tooltip absolute -top-10 left-1/2 -translate-x-1/2 bg-violet-600 text-white text-[10px] font-bold px-2 py-1 rounded shadow-xl whitespace-nowrap z-40">
                                ...
                                <div className="mt-8 grid grid-cols-3 gap-4 border-t border-white/10 pt-6">
                                    <div className="text-center">
                                        <div className="text-violet-400 font-bold text-xl mb-1">+1200</div>
                                        <div className="text-slate-500 text-xs uppercase tracking-wider">Rating Points</div>
                                    </div>
                                    <div className="text-center">
                                        <div className="text-white font-bold text-xl mb-1">16</div>
                        ...
                        <button
                            onClick={onRegister}
                            className="w-full md:w-auto px-8 md:px-10 py-4 rounded-full bg-violet-600 hover:bg-violet-500 text-white font-bold text-lg md:text-xl transition-all shadow-lg hover:shadow-violet-500/25 btn-premium"
                        >
                            Get Matched With a Beginner Coach
                        </button>
                    </div>

                    {/* RIGHT: Visual / Chart (DESKTOP) */}
                    <div className="hidden md:block flex-1 w-full order-1 md:order-2">
                        {/* Container with transparent background "remove background around logo" */}
                        <div className="p-2 md:p-6 relative">
                            ...
                            {/* Chart Area */}
                            <div className="relative h-[250px] md:h-[300px] w-full flex items-end gap-1 md:gap-2 px-2 ml-6 overflow-visible">
                                {/* Grid Lines & Labels */}
                                <div className="absolute inset-x-2 inset-y-0 flex flex-col justify-between pointer-events-none z-0">
                                    {/* 1200 Line */}
                                    <div className="w-full border-t border-dashed border-white/10 relative">
                                ...
                                {[
                                    ...
                                    <div key={index} className="flex-1 h-full flex flex-col justify-end chart-bar-group relative z-10">
                                        ...
                                        {/* Tooltip on hover */}
                                        <div className="chart-tooltip absolute -top-12 left-1/2 -translate-x-1/2 bg-violet-600 text-white text-[10px] font-bold px-3 py-1.5 rounded-lg shadow-xl whitespace-nowrap z-50 border border-white/10">
                                            {index === 0 ? 'Start' : index === 15 ? '1200' : `W${index + 1}`}
                                            <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-violet-600 rotate-45 border-b border-r border-white/10"></div>
                                        </div>
                                    </div>
                                ))}
