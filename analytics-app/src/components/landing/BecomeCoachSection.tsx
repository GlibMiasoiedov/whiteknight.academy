                ...
                <div className="w-full px-6 md:px-12 lg:px-16 xl:px-24 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 backdrop-blur-md mb-8">
                            ...
                            <span className={`text-xs md:text-sm font-bold text-emerald-400 uppercase tracking-wider ${FONTS.label}`}>Coaches: apply below</span>
                        </div>
                        <p className={`text-lg lg:text-xl xl:text-2xl text-slate-400 mb-10 md:mb-12 ${FONTS.body} leading-relaxed`}>
                        ...
                        <button onClick={() => setShowModal(true)} className={`bg-transparent border border-white/30 text-white px-10 py-4 rounded-full text-lg font-bold hover:bg-white hover:text-slate-900 transition-all btn-premium ${FONTS.body}`}>Apply as a Coach</button>
                    </div>
                </div>
            </section>
