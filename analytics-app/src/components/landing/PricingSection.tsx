        ...
        <section id="pricing" className="py-16 md:py-20 relative z-10">
            <div className="w-full px-6 md:px-12 lg:px-16 xl:px-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 xl:gap-12 items-center mb-24">
                    {/* Free Tier */}
                    <div className="p-8 xl:p-12 rounded-[3rem] bg-white/5 border border-white/5 relative group hover:bg-white/10 transition-colors">
                        ...
                        <button onClick={onRegister} className="w-full py-4 rounded-xl bg-white/10 hover:bg-white/20 text-white font-bold transition-all border border-white/10 btn-premium">
                            Get Free Report
                        </button>
                    </div>

                    {/* Pro Tier (Winner) */}
                    <GlassCard className="p-8 xl:p-14 ring-1 ring-violet-500 shadow-[0_0_100px_-20px_rgba(139,92,246,0.2)] transform md:scale-105 relative z-10 pro-card-hover">
                        ...
                        <div className="flex items-baseline gap-3 mb-4"><span className="text-5xl xl:text-7xl font-bold text-white font-display">€15</span><span className="text-slate-400 font-medium">/ month</span></div>
                        ...
                        <button onClick={() => navigate('/checkout')} className="w-full py-5 rounded-xl bg-white text-slate-900 font-bold text-xl shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_rgba(255,255,255,0.4)] hover:-translate-y-1 transition-all flex items-center justify-center gap-2 group btn-premium">
                            Start 14-Day Free Trial <ArrowRight className="group-hover:translate-x-1 transition-transform" />
                        </button>
                        <p className="text-center text-slate-400 text-sm mt-4 font-medium">Cancel anytime.</p>
                    </GlassCard>
                </div>
            </div>
        </section>
