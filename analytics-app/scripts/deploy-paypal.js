...
async function deployPayPal() {
    ...
    try {
        ...
        await client.uploadFrom("public/create-paypal-order.php", "/public_html/analytics/create-paypal-order.php");
        await client.uploadFrom("public/capture-paypal-order.php", "/public_html/analytics/capture-paypal-order.php");
        ...
        // Upload index.html (important for new chunks)
